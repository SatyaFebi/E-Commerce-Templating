                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach ($datas as $no => $data)
                                    <tr>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <!-- <a href="/payment_method/{{ $data->id_jenis_pembayaran }}/{{ $data->vwPaymentMethod->metode_pembayaran }}"
                                                    class="btn btn-sm btn-success">
                                                    <i class="fas fa-plus-circle me-2"></i>Add</a> -->
                                                    <a href="{{route('add', [$data->id_jenis_pembayaran, $data->vwPaymentMethod->metode_pembayaran])}}"
                                    ...
                                    <!--- Modal Logo --->
                                    <div class="modal fade" id="logo_{{ $data->id }}" tabindex="-1" aria-labelledby="logo_{{ $data->id }}Label" aria-hidden="true">
