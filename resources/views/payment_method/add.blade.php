    ...
    <div class="row g-4"> 
        <div class="col-12"> 
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{route('tambah')}}" method="POST" id="frmPaymentMethod" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control text-end" name="no_rek" id="norek" maxlength="25" type="text" aria-label="default input example" value="{{old('no_rek') ? old('no_rek') : '0'}}">
                        <div id="norekHelp" class="form-text text-warning">
                            Account Number Must be filled in and maximal 25 characters
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="tempat_bayar" class="form-label">Payment Place</label>
                        <input class="form-control" name="tempat_bayar" id="tempat_bayar" maxlength="50" type="text" aria-label="default input example" value="{{ old('tempat_bayar') }}">
                        <div id="tempat_bayarHelp" class="form-text text-warning">
                            Payment Place Must be filled in and maximal 50 characters
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <input class="form-control invisible" name="id_jenis_pembayaran" id="id_jenis_pembayaran" value="{{$id}}" type="text" aria-label="default input example">
                    <div class="text-end">
                        <a href="{{ route('payment_method.index') }}" class="btn btn-secondary">
                            <i class="fas fa-window-close me-2"></i>Cancel
                        </a>
                        <button type="button" class="btn btn-primary" id="save">
                            <i class="fas fa-save me-2"></i>Save New Detail
                        </button>
                    </div>
                </form>
            </div>
