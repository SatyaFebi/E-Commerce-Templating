    ...
    <header class="header-v3">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="fe/images/icons/logo_satya_store_2.png" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="fe/images/icons/logo_satya_store_2.png" alt="IMG-LOGO"></a>
			</div>
...
<!--===============================================================================================-->
	...
	<script src="fe/js/map-custom.js"></script>
