                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="{{route('paket.update', $data)}}" method="POST" name="frmPaket" id="frmPaket" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    placeholder="example: Regular Wedding Package" maxlength="50" value="{{$data->nama_paket ? $data->nama_paket : old('nama_paket')}}">
                                ...
                                <div class="mb-3">
                                 <label for="category" class="form-label">Category<span class="text-danger">*</span></label>
                                    <select class="form-select" id="category" name="kategori">
                                        ...
                                        <option value="Studi Tour" @if($data->kategori === 'Studi Tour' || old('kategori') === 'Studi Tour') selected @endif>Study Tour</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control text-end" id="pax_amount" name="jumlah_pax" value = "@if($data->jumlah_pax){{$data->jumlah_pax}} @elseif (old('jumlah_pax')) {{old('jumlah_pax')}} @else {{'0'}}@endif">
                                </div>
                                <div class="mb-3">
                                    <label for="price" class="form-label">Price<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control text-end" id="price" name="harga_paket" value = "@if($data->harga_paket){{$data->harga_paket}} @elseif (old('harga_paket')) {{old('harga_paket')}} @else {{'0'}} 
                                    @endif">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description<span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="Leave a description here" id="description" name="deskripsi" style="height: 150px;">
                                    {{$data->deskripsi ? $data->deskripsi : old('deskripsi')}}</textarea> 
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-5 text-end">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btnSimpan">
                                            <i class="fas fa-sd-card me-2"></i>Edit This Package!</button>
                                    </div>
                                </div>
                            </form>
                        </div>
