            ...
            <div class="bg-light rounded h-100 p-4 m-3">
                <div class="container mb-5">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <h3 class="text-secondary">Food Package::.Index</h3>
                        </div>
                        <div class="col-md-4 offset-md-4">
                            <a href ="{{ route('paket.create') }}" class="btn btn-primary m-2">
                                <i class="fas fa-cubes me-2"></i> Add New Food Package
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="align-middle">
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('paket.destroy', $data) }}" onclick="hapus(event, this)" 
                                                    class="btn btn-danger btn-sm"><i class="fas fa-trash-alt me-2"></i>Delete</a>
                                        </div>
                                    </td>
                                    <th scope="row">{{ $nmr + 1 . '.'}}</th>
                                    @if (strlen($data['nama_paket']) > 10)
                                        <td data-bs-toggle="tooltip" data-bs-placement="right"
                                            data-bs-tittle="{{ $data['nama_paket'] }}">
                                    ...
                                    @if (strlen($data['jenis']) > 5)
                                        <td data-bs-toggle="tooltip" data-bs-placement="right"
                                            data-bs-tittle="{{ $data['jenis'] }}">{{ substr($data['jenis'], 0, 5) . '...' }}</td>
                                    @else
                                        <td>{{ $data['jenis'] }}</td>
                                    @endif
                                    @if (strlen($data['kategori']) > 5)
                                        <td data-bs-toggle="tooltip" data-bs-placement="right"
                                            data-bs-tittle="{{ $data['kategori'] }}">
                                            {{ substr($data['kategori'], 0, 5) . '...' }}</td>
                                    @else
                                        <td>{{ $data['kategori'] }}</td>
                                    @endif
                                    ...
                                    <td>
                                        @if ($data['foto1'] !== null)
                                            <img src="storage/{{ $data['foto1'] }}" alt="" style="width: 50px"
                                    ...
                                    <td>
                                        @if ($data['foto2'] !== null)
                                            <img src="storage/{{ $data['foto2'] }}" alt="" style="width: 50px"
                                                class="img-thumbnail cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    <td>
                                        @if ($data['foto3'] !== null)
                                            <img src="storage/{{ $data['foto3'] }}" alt="" style="width: 50px"
                                                class="img-thumbnail cursor-pointer" data-bs-toggle="modal"
